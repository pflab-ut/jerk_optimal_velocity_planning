...
if __name__ == '__main__':
    ...
    ax1.plot(lp_data['qp_position'], lp_data['qp_velocity'], label="LP", color="blue", linewidth=linewidth_, marker="s", markersize=markersize_, markeredgecolor='blue')
    ...
    ax1.plot(ref_vel_data["position"], ref_vel_data["original_velocity"], color="brown", label="Obstacle Avoidance Velocity", linewidth=linewidth_)
    ax1.plot(ref_vel_data["position"], ref_vel_data["filtered_velocity"], color="orange", label="Jerk Filtered Velocity", linewidth=linewidth_)
    ...
    ax2.plot(lp_data['qp_position'], lp_data['qp_acceleration'], color="blue",linewidth=linewidth_, marker="s", markersize=markersize_, markeredgecolor='blue')
    ...
    ax3.plot(lp_data['qp_position'], lp_data['qp_jerk'], color="blue", linewidth=linewidth_, marker="s", markersize=markersize_, markeredgecolor='blue')
